                ...
                <form>
                    ...
                    <div className="row ">
                        <div className='col d-flex justify-content-center'>
                            <Link onClick={e => (!firstname || !lastname||!fathername||!enrollment||!registration||!program||!batch||!dateofgraduation||!cgpa||!other) ? e.preventDefault() : null} to={"/certificate_details"}>
